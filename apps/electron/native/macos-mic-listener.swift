 ...
 *
 * Long-running process that monitors microphone usage via CoreAudio
 * property listeners. Outputs MIC_ACTIVE / MIC_INACTIVE state transitions
 * to stdout. Event-driven with near-zero CPU usage.
 *
 * Compile:
 *   swiftc -O macos-mic-listener.swift -o macos-mic-listener \
